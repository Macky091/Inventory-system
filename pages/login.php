...
<div class="auth-wrapper">
  ...
  <div class="auth-brand">
    ...
    <p class="brand-sub">
      Track stock, manage products, and gain insights — all in one place.
    </p>
  </div>
  ...
  <div class="auth-form-area">
    <div class="auth-card">
      ...
      <div style="margin-top:1.25rem; padding:.85rem 1rem; background:var(--accent-dim);
                  border:1px solid var(--accent); border-radius:var(--radius); font-size:.8rem;">
        <strong style="color:var(--accent);">Demo credentials:</strong><br/>
        Username: <code style="font-family:monospace;">admin</code> &nbsp;|&nbsp;
